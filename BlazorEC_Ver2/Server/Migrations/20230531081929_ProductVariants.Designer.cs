...
namespace BlazorEC_Ver2.Server.Migrations
{
    ...
    [Migration("20230531081929_ProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorEC_Ver2.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorEC_Ver2.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("BlazorEC_Ver2.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorEC_Ver2.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorEC_Ver2.Shared.ProductType", "ProductType")
                        .WithMany()
